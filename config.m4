...
if test "$PHP_PTHREADS" != "no"; then
	...
	PHP_NEW_EXTENSION(pthreads, php_pthreads.c src/debug.c src/lock.c src/globals.c src/prepare.c src/synchro.c src/state.c src/store.c src/resources.c src/modifiers.c src/handlers.c src/object.c, $ext_shared)
